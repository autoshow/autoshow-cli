import { callWhisper } from '@/transcription/transcription-local/whisper.ts'
import { callDeepgram } from '@/transcription/transcription-services/deepgram.ts'
import { callAssembly } from '@/transcription/transcription-services/assembly.ts'
import { callGroqWhisper } from '@/transcription/transcription-services/groq-whisper.ts'
import { callWhisperCoreml } from '@/transcription/transcription-local/whisper-coreml.ts'
