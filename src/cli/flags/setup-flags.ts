...
export const setupFlags = {
  ...
  ...setupSampleFlags,
  step: {
    description: 'Run only a specific setup step: uv|yt-dlp|whisper-binary|whisper-model|llama-binary|reverb|calibre|all|transcription|write|tts|image|music|sample (default: all). Assumes prerequisites are already installed for isolated steps.',
    type: String,
    default: 'all'
  },
  'force-redownload': {
