...
import { SUPPORTED_LLAMA_MODELS, SUPPORTED_KITTEN_TTS_MODELS } from '~/cli/commands/models/model-options'
import { withRetry } from '~/utils/retries'
import { validateJson } from '~/utils/validate/validation'
import { setupYtDependencies } from '../../step-1-download/setup-download/dl-audio/audio'
import { setupWhisper, downloadWhisperModel } from '../../step-2-stt/stt-local/whisper/whisper'
...
import { setupCalibreDocumentTools } from '../../step-1-download/setup-download/dl-document/calibre'
import { setupExtractionOcr } from '../../step-2-document/document-local/extract'
import { setupMistralOcr } from '../../step-2-document/document-services/mistral-ocr/mistral'
import { setupKittenTts } from '../../step-4-tts/tts-local/kitten/kitten-tts'
import { setupElevenLabsTts } from '../../step-4-tts/tts-services/elevenlabs/elevenlabs-tts'
import { setupGroqTts } from '../../step-4-tts/tts-services/groq/groq-tts'
import { setupOpenAITts } from '../../step-4-tts/tts-services/openai/openai-tts'
import { setupGeminiTts } from '../../step-4-tts/tts-services/gemini/gemini-tts'
import { setupGeminiImageGen } from '../../step-5-image/image-services/gemini/gemini-image-gen'
import { setupOpenAIImageGen } from '../../step-5-image/image-services/openai/openai-image-gen'
import { setupElevenLabsMusicGen } from '../../step-7-music/music-services/elevenlabs/elevenlabs-music-gen'
import { setupMinimaxMusicGen } from '../../step-7-music/music-services/minimax/minimax-music-gen'
import { ensureLlamaModelDownloaded } from '../../step-3-write/write-local/llama/run-llama'
import { ensureKittenTtsSetup } from '../../step-4-tts/tts-local/kitten/kitten-tts'
...
const runFullSetup = async (): Promise<void> => {
  ...
  await withCompactSetup(async () => { await setupMistralStt(); await setupMistralOcr() })
