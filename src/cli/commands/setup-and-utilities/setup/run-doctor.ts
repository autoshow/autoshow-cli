...
export const runDoctor = async (): Promise<void> => {
  ...
  checks.push(checkEnvVar('XAI_API_KEY (Grok STT/OCR/TTS/image/video)', 'XAI_API_KEY'))
  ...
  checks.push(checkEnvVar('RUNWAYML_API_SECRET (Runway video)', 'RUNWAYML_API_SECRET'))
