...
const sharedOptions = (cmd: Command): Command => cmd
  ...
  .option('--fish-model <model>', 'FishAudio model: s1-mini (default), s1')
  ...
  .option('--cosyvoice-model <model>', 'CosyVoice model: Fun-CosyVoice3-0.5B, CosyVoice2-0.5B, CosyVoice-300M, CosyVoice-300M-SFT, CosyVoice-300M-Instruct (default), CosyVoice-ttsfrd')
