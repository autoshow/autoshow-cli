...
export const DEFAULT_OCR_REQUEST_TIMEOUT_MS = 60 * 60_000
export const OCR_REQUEST_TIMEOUT_MS = readPositiveIntegerEnv(
  'AUTOSHOW_OCR_REQUEST_TIMEOUT_MS',
  DEFAULT_OCR_REQUEST_TIMEOUT_MS
)

export const DEFAULT_OCR_POLL_DEADLINE_MS = 60 * 60_000
export const OCR_POLL_DEADLINE_MS = readPositiveIntegerEnv(
