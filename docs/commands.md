...
- `extract`: [local](./commands/step-2-extract/extract-document-local.md) | [services](./commands/step-2-extract/extract-document-services.md) | [setup](./commands/step-2-extract/extract-document-setup.md)
- `transcribe`: [local](./commands/step-2-transcribe/transcribe-audio-local.md) | [services](./commands/step-2-transcribe/transcribe-audio-services.md) | [setup](./commands/step-2-transcribe/transcribe-audio-setup.md)
- `write`: [local](./commands/step-3-write/write-text-local.md) | [services](./commands/step-3-write/write-text-services.md) | [setup](./commands/step-3-write/write-text-setup.md)
- `tts`: [local](./commands/step-4-tts/text-to-speech-local.md) | [services](./commands/step-4-tts/text-to-speech-services.md) | [setup](./commands/step-4-tts/text-to-speech-setup.md)
...
- Use `extract` for documents/images when you only need OCR/text extraction.
- Use `transcribe` for audio/video when you only need transcript + prompt output.
...
```bash
bun as transcribe input/1-audio.mp3 --elevenlabs-stt scribe_v2 --price
bun as transcribe input/1-audio.mp3 --groq-stt whisper-large-v3 --price
