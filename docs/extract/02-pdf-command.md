# PDF Command - PDF Text Extraction
...
| Option | Description |
|--------|-------------|
| `-o, --output <path>` | Output file path (defaults to `<input>_extracted.txt`) |
| `--page-breaks` | Include page break markers in output |
| `--model <model>` | Model to use: `gpt-4.1`, `gpt-4.1-mini` (default), `gemini-2.0-flash` |
| `--service <service>` | Extraction service: `zerox` (default), `unpdf`, `textract` |
