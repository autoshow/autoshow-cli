...
| `speakerCount` | `--speaker-count` | Optional diarization speaker count hint for ElevenLabs and AssemblyAI; Deepgram, Soniox, Speechmatics, Mistral, and OpenAI ignore count-only hints |
