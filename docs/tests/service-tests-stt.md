...
- Provider-specific suites live under `test/test-cases/e2e/step-2-stt-e2e/stt-services/assemblyai/`, `deepgram/`, `elevenlabs/`, `groq/`, `mistral/`, `openai/`, `rev/`, and `speechmatics/`.
