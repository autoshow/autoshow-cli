...
export const videoRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-6-video-gen-e2e/video-gen.test.ts', [
    ...
    command('video-multi-gemini-lite-deapi-ltxv', 'video-multi-gemini-lite-deapi-ltxv', ['src/cli/create-cli.ts', 'video', 'a static shot of a tiny red dot on white background', '--gemini-video', 'veo-3.1-lite-generate-preview', '--deapi-video', 'Ltxv_13B_0_9_8_Distilled_FP8', '--video-duration', '1', '--video-size', '256x256', '--price']),
  ]),
]

export const videoCatalogRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-price/catalog/step-6-video/deapi', [
    command('video-deapi-Ltx2_19B_Dist_FP8', 'video-deapi-Ltx2_19B_Dist_FP8', ['src/cli/create-cli.ts', 'video', 'a cinematic mountain sunrise', '--deapi-video', 'Ltx2_19B_Dist_FP8', '--price'], false),
    command('video-deapi-Ltx2_3_22B_Dist_INT8', 'video-deapi-Ltx2_3_22B_Dist_INT8', ['src/cli/create-cli.ts', 'video', 'a cinematic mountain sunrise', '--deapi-video', 'Ltx2_3_22B_Dist_INT8', '--price'], false),
  ]),
]
