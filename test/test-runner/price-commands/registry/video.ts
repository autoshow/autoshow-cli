...
export const videoRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-6-video-gen-e2e/video-gen.test.ts', [
    ...
    command('video-gemini-veo-3.1-lite-generate-preview', 'video-gemini-veo-3.1-lite-generate-preview', ['src/cli/create-cli.ts', 'video', 'a cinematic mountain sunrise', '--gemini-video', 'veo-3.1-lite-generate-preview', '--price']),
