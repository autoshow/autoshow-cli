...
export const ttsRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-4-tts-e2e/tts-services/service-models.test.ts', [
    ...
    command('tts-mistral-dialogue-ref-audio', 'tts-mistral-dialogue-ref-audio', ['src/cli/create-cli.ts', 'tts', 'input/examples/tts/tts-dialogue.txt', '--mistral-tts', 'voxtral-mini-tts-2603', '--tts-dialogue-format', 'labeled', '--tts-speaker-ref-audio', 'Host=input/examples/audio/anthony-voice.mp3', '--tts-speaker-ref-audio', 'Guest=input/examples/audio/1-audio.mp3', '--price']),
    ...
    command('tts-hume-octave-2', 'tts-hume-octave-2', ['src/cli/create-cli.ts', 'tts', 'input/examples/tts/1-tts.md', '--hume-tts', 'octave-2', '--price']),
    command('tts-cartesia-sonic-3', 'tts-cartesia-sonic-3', ['src/cli/create-cli.ts', 'tts', 'input/examples/tts/1-tts.md', '--cartesia-tts', 'sonic-3', '--price']),
    command('tts-cartesia-sonic-3.5', 'tts-cartesia-sonic-3.5', ['src/cli/create-cli.ts', 'tts', 'input/examples/tts/1-tts.md', '--cartesia-tts', 'sonic-3.5', '--price']),
    command('tts-gcloud-chirp3-hd', 'tts-gcloud-chirp3-hd', ['src/cli/create-cli.ts', 'tts', 'input/examples/tts/1-tts.md', '--gcloud-tts', 'chirp3-hd', '--price']),
