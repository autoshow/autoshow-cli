...
const minimaxGeminiClipMusicCommand = command(
  ...
  'music-multi-minimax-music-2.5-gemini-lyria-3-clip-preview',
  ['src/cli/create-cli.ts', 'music', 'bright acoustic pop with handclaps and a catchy chorus', '--minimax-music', 'music-2.5', '--gemini-music', 'lyria-3-clip-preview', '--music-lyrics-file', 'input/examples/tts/1-tts.md', '--price']
)
...
export const musicRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-7-music-gen-e2e/elevenlabs-music-gen.test.ts', [
    command('music-elevenlabs-music_v1', 'music-elevenlabs-music_v1', ['src/cli/create-cli.ts', 'music', 'an ambient piano song', '--elevenlabs-music', 'music_v1', '--music-duration', '3', '--music-instrumental', '--price']),
  ...
  ...exact('test/test-cases/e2e/step-7-music-gen-e2e/gemini-music-gen.test.ts', [
    command('music-gemini-lyria-3-pro-preview', 'music-gemini-lyria-3-pro-preview', ['src/cli/create-cli.ts', 'music', 'an ambient piano song', '--gemini-music', 'lyria-3-pro-preview', '--music-duration', '30', '--price']),
  ]),
]
