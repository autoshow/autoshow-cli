...
const minimaxGeminiClipMusicCommand = command(
  ...
  'music-multi-minimax-music-2.6-gemini-lyria-3-clip-preview',
  ['src/cli/create-cli.ts', 'music', 'bright acoustic pop with handclaps and a catchy chorus', '--minimax', 'music-2.6', '--gemini', 'lyria-3-clip-preview', '--music-lyrics-file', 'input/examples/tts/1-tts.md', '--price']
)
...
export const musicRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/step-7-music-gen-e2e/minimax-music-gen.test.ts', [
    ...
    command('music-pipeline-minimax-music-2.6', 'music-pipeline-minimax-music-2.6', ['src/cli/create-cli.ts', 'write', 'https://ajc.pics/autoshow/examples/1-audio.mp3', '--minimax-music', 'music-2.6', '--music-lyrics-file', 'input/examples/tts/1-tts.md', '--price']),
