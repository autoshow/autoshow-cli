...
export const sttRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/step-2-stt-e2e/stt-services/service-models.test.ts', [
    ...
    command('transcribe-fireworks-whisper-v3-turbo', 'transcribe-fireworks-whisper-v3-turbo', ['src/cli/create-cli.ts', 'extract', 'input/examples/audio/1-audio.mp3', '--fireworks-stt', 'whisper-v3-turbo', '--price']),
    command('transcribe-fireworks-whisper-v3', 'transcribe-fireworks-whisper-v3', ['src/cli/create-cli.ts', 'extract', 'input/examples/audio/1-audio.mp3', '--fireworks-stt', 'whisper-v3', '--price']),
