...
export const writeRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-3-write-e2e/write-services/service-models.test.ts', [
    command('write-openai-gpt-5.4', 'write-openai-gpt-5.4', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--openai', 'gpt-5.4', '--prompt', 'shortSummary', '--price']),
    command('write-openai-gpt-5.4-pro', 'write-openai-gpt-5.4-pro', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--openai', 'gpt-5.4-pro', '--prompt', 'shortSummary', '--price']),
    command('write-openai-gpt-5.4-mini', 'write-openai-gpt-5.4-mini', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--openai', 'gpt-5.4-mini', '--prompt', 'shortSummary', '--price']),
    ...
    command('write-anthropic-claude-opus-4-7', 'write-anthropic-claude-opus-4-7', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--anthropic', 'claude-opus-4-7', '--prompt', 'shortSummary', '--price']),
    command('write-anthropic-claude-opus-4-6', 'write-anthropic-claude-opus-4-6', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--anthropic', 'claude-opus-4-6', '--prompt', 'shortSummary', '--price']),
    command('write-anthropic-claude-sonnet-4-6', 'write-anthropic-claude-sonnet-4-6', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--anthropic', 'claude-sonnet-4-6', '--prompt', 'shortSummary', '--price']),
    ...
    command('write-gemini-gemini-3.1-pro-preview', 'write-gemini-gemini-3.1-pro-preview', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--gemini', 'gemini-3.1-pro-preview', '--prompt', 'shortSummary', '--price']),
    ...
    command('write-groq-openai/gpt-oss-120b', 'write-groq-openai/gpt-oss-120b', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--groq', 'openai/gpt-oss-120b', '--prompt', 'shortSummary', '--price']),
    ...
    command('write-minimax-MiniMax-M2.5-highspeed', 'write-minimax-MiniMax-M2.5-highspeed', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--minimax', 'MiniMax-M2.5-highspeed', '--prompt', 'shortSummary', '--price']),
    command('write-grok-grok-4.20-reasoning', 'write-grok-grok-4.20-reasoning', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--grok', 'grok-4.20-reasoning', '--prompt', 'shortSummary', '--price']),
  ...
  ...exact('test/test-cases/e2e/step-4-tts-e2e/tts-services/kitten-tts-pipeline.test.ts', [
    command('write-groq-openai/gpt-oss-20b', 'write-groq-openai/gpt-oss-20b', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--groq', 'openai/gpt-oss-20b', '--prompt', 'shortSummary', '--price']),
    command('write-openai-gpt-5.4', 'write-openai-gpt-5.4', ['src/cli/create-cli.ts', 'write', 'input/examples/audio/1-audio.mp3', '--openai', 'gpt-5.4', '--prompt', 'shortSummary', '--price']),
  ]),
