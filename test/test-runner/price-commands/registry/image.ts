...
export const imageCatalogRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-price/catalog/step-5-image/bfl', [
    command('image-bfl-flux-2-klein-4b', 'image-bfl-flux-2-klein-4b', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-klein-4b', '--price'], false),
    command('image-bfl-flux-2-klein-9b-preview', 'image-bfl-flux-2-klein-9b-preview', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-klein-9b-preview', '--price'], false),
    command('image-bfl-flux-2-klein-9b', 'image-bfl-flux-2-klein-9b', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-klein-9b', '--price'], false),
    command('image-bfl-flux-2-pro', 'image-bfl-flux-2-pro', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-pro', '--price'], false),
    command('image-bfl-flux-2-max', 'image-bfl-flux-2-max', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-max', '--price'], false),
    command('image-bfl-flux-2-flex', 'image-bfl-flux-2-flex', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl', 'flux-2-flex', '--price'], false),
  ]),
]
