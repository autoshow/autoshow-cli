...
export const imageRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-5-image-gen-e2e/openai-image-gen.test.ts', [
    command('image-openai-gpt-image-1', 'image-openai-gpt-image-1', ['src/cli/create-cli.ts', 'image', 'an oil painting of a lighthouse', '--openai-image', 'gpt-image-1', '--image-quality', 'high', '--image-size', '1536x1024', '--price']),
    command('image-openai-gpt-image-1-mini', 'image-openai-gpt-image-1-mini', ['src/cli/create-cli.ts', 'image', 'a sunset', '--openai-image', 'gpt-image-1-mini', '--image-format', 'jpeg', '--image-size', '1024x1024', '--image-quality', 'low', '--price']),
    ...
    command('image-openai-gpt-image-2', 'image-openai-gpt-image-2', ['src/cli/create-cli.ts', 'image', 'a sunset', '--openai-image', 'gpt-image-2', '--image-size', '1024x1536', '--image-quality', 'low', '--price']),
  ]),
  ...
  ...exact('test/test-cases/e2e/step-5-image-gen-e2e/minimax-image-gen.test.ts', [
    command('image-minimax-image-01', 'image-minimax-image-01', ['src/cli/create-cli.ts', 'image', 'a dramatic fox portrait in snow', '--minimax-image', 'image-01', '--image-aspect-ratio', '16:9', '--price']),
  ]),
...
export const imageCatalogRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-price/catalog/step-5-image/bfl', [
    command('image-bfl-flux-2-klein-4b', 'image-bfl-flux-2-klein-4b', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-klein-4b', '--price'], false),
    command('image-bfl-flux-2-klein-9b-preview', 'image-bfl-flux-2-klein-9b-preview', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-klein-9b-preview', '--price'], false),
    command('image-bfl-flux-2-klein-9b', 'image-bfl-flux-2-klein-9b', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-klein-9b', '--price'], false),
    command('image-bfl-flux-2-pro', 'image-bfl-flux-2-pro', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-pro', '--price'], false),
    command('image-bfl-flux-2-max', 'image-bfl-flux-2-max', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-max', '--price'], false),
    command('image-bfl-flux-2-flex', 'image-bfl-flux-2-flex', ['src/cli/create-cli.ts', 'image', 'a sunset', '--bfl-image', 'flux-2-flex', '--price'], false),
  ]),
]
