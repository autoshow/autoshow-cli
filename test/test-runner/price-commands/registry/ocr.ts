...
export const ocrRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-2-ocr-e2e/ocr-services/service-models.test.ts', [
    ...
    command('extract-kimi-kimi-k2.6', 'extract-kimi-kimi-k2.6', ['src/cli/create-cli.ts', 'extract', 'input/examples/document/1-document.pdf', '--kimi-ocr', 'kimi-k2.6', '--price']),
    ...
    command('extract-deepinfra-allenai/olmOCR-2-7B-1025', 'extract-deepinfra-allenai/olmOCR-2-7B-1025', ['src/cli/create-cli.ts', 'extract', 'input/examples/document/1-document.pdf', '--deepinfra-ocr', 'allenai/olmOCR-2-7B-1025', '--price']),
