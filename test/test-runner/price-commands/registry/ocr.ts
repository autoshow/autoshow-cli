...
export const ocrRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-2-ocr-e2e/ocr-services/service-models.test.ts', [
    ...
    command('extract-anthropic-claude-haiku-4-5', 'extract-anthropic-claude-haiku-4-5', ['src/cli/create-cli.ts', 'ocr', 'input/examples/document/1-document.pdf', '--anthropic-ocr', 'claude-haiku-4-5', '--price']),
    command('extract-gemini-gemini-3.1-flash-lite-preview', 'extract-gemini-gemini-3.1-flash-lite-preview', ['src/cli/create-cli.ts', 'ocr', 'input/examples/document/1-document.pdf', '--gemini-ocr', 'gemini-3.1-flash-lite-preview', '--price']),
  ]),
