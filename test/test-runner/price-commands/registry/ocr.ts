...
export const ocrRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/step-2-ocr-e2e/ocr-services/service-models.test.ts', [
    ...
    command('extract-openai-gpt-5.5', 'extract-openai-gpt-5.5', ['src/cli/create-cli.ts', 'extract', 'https://ajc.pics/autoshow/benchmarks/ocr/1-document.png', '--openai', 'gpt-5.5', '--price']),
    ...
    command('extract-grok-grok-4.3', 'extract-grok-grok-4.3', ['src/cli/create-cli.ts', 'extract', 'https://ajc.pics/autoshow/benchmarks/ocr/1-document.png', '--grok', 'grok-4.3', '--price']),
    command('extract-anthropic-claude-opus-4-7', 'extract-anthropic-claude-opus-4-7', ['src/cli/create-cli.ts', 'extract', 'https://ajc.pics/autoshow/benchmarks/ocr/1-document.png', '--anthropic', 'claude-opus-4-7', '--price']),
    command('extract-anthropic-claude-sonnet-4-6', 'extract-anthropic-claude-sonnet-4-6', ['src/cli/create-cli.ts', 'extract', 'https://ajc.pics/autoshow/benchmarks/ocr/1-document.png', '--anthropic', 'claude-sonnet-4-6', '--price']),
