...
export const ocrRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-2-ocr-e2e/ocr-services/openai-gpt-5.4.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/step-2-ocr-e2e/ocr-services/openai-gpt-5.4-mini.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/step-2-ocr-e2e/ocr-services/anthropic-claude-opus-4-7.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/step-2-ocr-e2e/ocr-services/anthropic-claude-sonnet-4-6.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/step-2-ocr-e2e/ocr-services/unstructured-hi-res-and-enrichment.test.ts', [
