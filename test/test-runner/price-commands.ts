...
export const PRICE_SELECTION_REGISTRY: PriceSelectionEntry[] = [
  ...
  ...prefix('test/test-cases/e2e/step-3-write-e2e/write-services/openai/', [
    command('write-openai-gpt-5.4', 'write-openai-gpt-5.4', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--openai', 'gpt-5.4', '--price']),
    command('write-openai-gpt-5.4-pro', 'write-openai-gpt-5.4-pro', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--openai', 'gpt-5.4-pro', '--price']),
    command('write-openai-gpt-5.4-mini', 'write-openai-gpt-5.4-mini', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--openai', 'gpt-5.4-mini', '--price']),
    command('write-openai-gpt-5.4-nano', 'write-openai-gpt-5.4-nano', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--openai', 'gpt-5.4-nano', '--price']),
  ]),
  ...prefix('test/test-cases/e2e/step-3-write-e2e/write-services/anthropic/', [
    ...
    command('write-anthropic-claude-haiku-4-5', 'write-anthropic-claude-haiku-4-5', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--anthropic', 'claude-haiku-4-5', '--price']),
  ]),
  ...prefix('test/test-cases/e2e/step-3-write-e2e/write-services/gemini/', [
    command('write-gemini-gemini-3.1-pro-preview', 'write-gemini-gemini-3.1-pro-preview', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--gemini', 'gemini-3.1-pro-preview', '--price']),
    command('write-gemini-gemini-3.1-flash-lite-preview', 'write-gemini-gemini-3.1-flash-lite-preview', ['src/cli/create-cli.ts', 'write', 'input/1-audio.mp3', '--gemini', 'gemini-3.1-flash-lite-preview', '--price']),
  ]),
