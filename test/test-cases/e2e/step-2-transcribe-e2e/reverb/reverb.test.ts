...
test("reverb processes local audio with speaker diarization and verbatimicity options", async () => {
...
test('reverb processes local audio without verbatimicity option', async () => {
  await cleanupTestOutput(STABLE_LOCAL_AUDIO_TITLE)
