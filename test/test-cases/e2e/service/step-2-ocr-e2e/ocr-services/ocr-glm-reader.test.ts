...
budgetedTest('extract-glm-reader-url', 'bun as extract https://ajcwebdev.com --url-provider glm-reader', async () => {
  ...
  try {
    ...
    const result = await runCommand(
      args,
      { testName: 'bun as extract https://ajcwebdev.com --url-provider glm-reader' }
    )
