...
const EXPECTED_BUDGET_KEYS = [
  ...
  'transcribe-deapi-WhisperLargeV3',
  'transcribe-deepgram-nova-3',
  'transcribe-deepinfra-openai-whisper-large-v3',
  'transcribe-deepinfra-openai-whisper-large-v3-turbo',
  ...
  'write-anthropic-claude-opus-4-7',
